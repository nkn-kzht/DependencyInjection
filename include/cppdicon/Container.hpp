...
class Container {
 public:
  Container()
      : _componentManager(*this),
        _singletonComponentManager(*this) {
  }
  ~Container() = default;
 ...
 private:
  ...
  Container&
  operator=(const Container& obj) = delete;
  Container&
  operator=(Container&& obj) = delete;
  class ComponentManager {
   public:
    ComponentManager() = delete;
    explicit ComponentManager(const Container& container)
   ...
   private:
    ...
    ComponentManager&
    operator=(const ComponentManager& obj) = delete;
    ComponentManager&
    operator=(ComponentManager&& obj) = delete;
  ...
  class SingletonComponentManager {
   public:
    ...
    explicit SingletonComponentManager(const Container& container)
        : _container(container) {
    }
   ...
   private:
    ...
    operator=(const SingletonComponentManager& obj) = delete;
    SingletonComponentManager&
    operator=(SingletonComponentManager&& obj) = delete;
    const Container& _container;
  };
